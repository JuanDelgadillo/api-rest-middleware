...
module.exports.ok = function (res, payload) {
  return res
    .status(ok.code)
    .json(Array.isArray(payload) ? payload : { ...payload });
};

module.exports.badRequest = function (res, payload) {
  return res
    .status(badRequest.code)
    .json({ message: badRequest.message, code: badRequest.code, ...payload });
};
...
module.exports.serviceUnavailable = function (res, payload) {
  return res.status(serviceUnavailable.code).json({
...
module.exports.notFound = function (res, payload) {
  return res
    ...
    .json({ message: notFound.message, code: notFound.code, ...payload });
};
